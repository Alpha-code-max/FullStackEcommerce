...
export const ProductCreateOneSchema = z.object({ select: ProductSelectObjectSchema.optional(),  data: z.union([ProductCreateInputObjectSchema, ProductUncheckedCreateInputObjectSchema])  })