...
export default function HomePage() {
  ...
  // Show top 3 products as featured (or fallback if loading)
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-28">
        ...
        <section className="text-center space-y-6">
          ...
          <Link href="/products" className="inline-block mt-8 relative group">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="text-center">
                <Link href="/products" className="inline-flex items-center gap-2 px-6 py-3 text-lg font-semibold text-blue-600 hover:text-blue-700 group">
                  View All Products
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
        ...
        <section className="text-center py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl sm:rounded-3xl text-white space-y-6 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-4 px-4">
            <Button asChild className="bg-white text-blue-600 hover:bg-gray-100 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold shadow-md hover:shadow-lg transition-all">
              <Link href="/contact">Contact Us</Link>
            </Button>
            <Button asChild variant="outline" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold shadow-md hover:shadow-lg transition-all">
